 ...
 *
 * Disassembly of DSDT.aml, Wed Apr 15 14:32:52 2020
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000B97E (47486)
 *     Revision         0x02
 *     Checksum         0x30
 *     OEM ID           "DELL  "
 *     OEM Table ID     "CBX3   "
...
DefinitionBlock ("", "DSDT", 2, "DELL  ", "CBX3   ", 0x00000014)
{
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xD47FCC18, 0x02B3)
    ...
    OperationRegion (EXBU, SystemMemory, 0xD47FFF18, 0x000D)
    ...
    Scope (_SB.PCI0.LPCB)
    {
        OperationRegion (CPSB, SystemMemory, 0xD5FFEE18, 0x10)
